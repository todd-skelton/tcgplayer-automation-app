...
Comparisons identify newly observed listings, absence from a partial scan, and observed price/availability/quantity/detail changes. None establish a sale or continuous exposure. The small seller-outcome contract distinguishes sales, linked cancellations and relists, rejects conflicting/future records and requires notes for manual evidence. [Reviewed outcome imports](slab-seller-outcomes.md) now persist this evidence separately from inventory and market comps. Seller OAuth, verified provider outcomes and time-separated exposure validation remain prerequisites for that part of #30.
