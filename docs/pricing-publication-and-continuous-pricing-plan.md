...
- 2026-08-06: Continuous pricing was enabled for seller 8520a14f with a 24-hour per-SKU minimum interval, 60-minute seller-inventory refresh, 30-second scheduler poll, and 50-SKU micro-batches. Automatic publication is enabled only for the continuous source; pending-inventory, seller, and CSV sources remain disabled.
...
- 2026-08-06: Production was deployed from commit 5a7a3e640 with automatic publication paused during the rollout and re-enabled only after the live policy omitted both percentage-cap fields. Batch 97 then published 36 of 36 eligible price-only changes through publication 10 and staged upload 16128005 with 0 failed and 0 ambiguous.
- 2026-08-06: The corrected live policy published Tenacity of the Monarchs from $0.49 to $0.99, a 102.04% increase that the removed cap would have blocked. A fresh seller snapshot matched all 36 desired prices; 35 quantities matched their batch observations, while Clefairy legitimately sold from quantity 1 to 0 and remained 0 because the publication quantity delta was zero.
- 2026-08-06: The 12 SKUs previously held by the removed percentage caps were verified enabled, in stock, unpaused, and absent from active batches, then admitted exactly once to fresh recovery batch 117 for repricing under the corrected policy.
